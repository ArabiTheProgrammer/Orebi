...
const ShoppingCartDropdown = () => {
  return (
    <>
      <ul className="absolute z-10 flex flex-col translate-y-8 right-0">
        ...
        <List2 href="/">
            ...
            <div className="Button lg:pl-[20px] pl-[13px] lg:pb-[20px] pb-[10px] flex gap-[21px] ">
              <button className="border border-[#2B2B2B] hover:bg-[#262626] text-[#262626] hover:text-[#FFF] transition-all duration-300 font-DM font-bold lg:pl-[43px] px-[25px] lg:pr-[39px]">View Cart</button>
